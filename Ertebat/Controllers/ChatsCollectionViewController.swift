...
class ChatsCollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        Messages.shared.addMessageListener { (messageDataArray) in
            self.messsageData = messageDataArray
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let message = messsageData[indexPath.row].messages.first
        if message != nil{
            cell.titleLabel.text = messsageData[indexPath.row].user.name
            cell.messageLabel.text = message?.text
            if let urlString = messsageData[indexPath.row].user.profileUrl{
